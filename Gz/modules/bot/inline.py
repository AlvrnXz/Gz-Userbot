...
from Gz import CMD_HELP, StartTime, app
from Gz.helper.data import Data
from Gz.helper.inline import inline_wrapper, paginate_help
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://graph.org/file/1e53a14e6a70757d1d736.jpg",
...
async def help_function(answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            title="Help Article!",
            description="Periksa Daftar Perintah & Help",
            thumb_url="https://graph.org/file/1e53a14e6a70757d1d736.jpg",
            input_message_content=InputTextMessageContent(

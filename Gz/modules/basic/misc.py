...
from Gz import START_TIME
from Gz import SUDO_USER
from Gz.helper.PyroHelpers import ReplyCheck
from Gz.modules.help import add_command_help
from Gz.modules.bot.inline import get_readable_time

alive_logo = ALIVE_PIC or "https://graph.org/file/1e53a14e6a70757d1d736.jpg"
...
if ALIVE_TEXT:
   txt = ALIVE_TEXT
    ...
    txt = (
        ...
        f"├• **ꜱᴜᴘᴘᴏʀᴛ**: [Click](t.me/GzSupportGroup)\n"
        f"├• **ᴄʜᴀɴɴᴇʟ**: [Click](t.me/eageza)\n"
        f"└• **ʀᴇᴘᴏ**: [Click](https://GitHub.com/alvrnxz/Gz-Userbot)"        
    )
...
async def repo(bot: Client, message: Message):
    ...
    await message.edit("Mengambil Kode Sumber.....")
    await asyncio.sleep(1)
    await message.edit("Here is repo: \n\n\nhttps://github.com/alvrnxz/Gz-UserBot\nFork & Give an ⭐")


@Client.on_message(filters.command("creator", ".") & filters.me)
async def creator(bot: Client, message: Message):
    await message.edit("https://gitHub.com/alvrnxz/Gz-Userbot")
